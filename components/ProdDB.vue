      ...
      <div class="col">
        ...
        <table class="table table-striped">
          <thead>
             <tr>
              <tr>
              <th scope="col" @click="sortBy('title')" style="width: 35%">
                Title
              </th>
              <th scope="col" @click="sortBy('production')" style="width: 10%">
                Production
              </th>
              <th scope="col" @click="sortBy('responsible')" style="width: 20%">
                Responsible
              </th>
...
export default {
  ...
  methods: {
    getDBs() {
      const path = 'http://dc-pg-dev:3000/prod_db';
      axios.get(path)
        .then((res) => {
